...
coursecode: "ECON 306 Spring 2023"
author: Dr. Ryan Safner
semester: "[microS23.classes.ryansafner.com](http://microS23.classes.ryansafner.com)"
...
Your final course grade is the weighted average of the following assignments. You can find general descriptions for all the assignments on the [assignments page](https://microS23.classes.ryansafner.com/assignments/) and more specific information and examples on each assignment's page on the [schedule page](https://microS23.classes.ryansafner.com/schedule/). 
...
**You can find a full schedule** with much more details, including the readings, appendices, and other further resources for each class meeting on the [schedule page](https://microS23.classes.ryansafner.com/schedule/).