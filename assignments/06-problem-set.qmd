...
<p style="text-align:center;"><a class="btn btn-primary btn-lg" target="_blank" href="/files/assignment/06-problem-set-pdf.pdf"><i class="fas fa-file-pdf"></i> Download as PDF</a> <a class="btn btn-primary btn-lg" target="_blank" href="/files/assignment/06-problem-set-docx.docx"><i class="fa-regular fa-file-word"></i> Download as .docx</a></p>
